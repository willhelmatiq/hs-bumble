import "../../design-tokens/css/_variables.css";
...
const Template = (args) => `
  <style>
    ...
    .stack-item:nth-child(even) { background-color: var(--hs-color-background-color-background-primary); }
    .stack-item:nth-child(odd) { background-color: var(--hs-color-typography-header-color-header-neutralcool-darker); }
  </style>
  <bm-stack orientation="${args.orientation}" gap="${args.gap}">
